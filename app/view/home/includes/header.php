            ...
            <div class="nav-links-wrapper flex items-center justify-between gap-3">
                ...
                <div class="search-form-wrapper">
                    ...
                    <div class="search-form absolute w-full bg-white p-4 top-20 left-0 md:static md:bg-transparent md:p-0 hidden md:block">
                        <form class="search-form flex items-center" method="post">   
                            <label for="simple-search" class="sr-only">Search</label>
                            <div class="relative w-full">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
                                </div>
                                <input type="text" id="search-field" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="account-links ml-3">
                    ...
                    <button id="dropdownAvatarNameButton" data-dropdown-toggle="dropdownAvatarName" class="flex items-center text-sm font-medium text-white rounded-full hover:text-primary md:mr-0" type="button">
                        ...
                        <img class="header-profile-image w-8 h-8 mr-2 rounded-full" alt="user photo">
                        <p class="user-name"></p>
                        <?php // ($_SESSION["user-logged"]) ? $_SESSION["user-name"] : "" ?>
                    ...
                    <div id="dropdownAvatarName" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44">
                        ...
                        <div class="truncate user-email"><?php //($_SESSION["user-logged"]) ? $_SESSION["user-email"] : "" ?></div>
                        </div>
